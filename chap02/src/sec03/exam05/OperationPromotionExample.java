...
//		char charValue3 = charValue1 + charValue2; // int + int
		...
		// 문자로 출력하고 싶다면 char 타입으로 강제 형변환 , 안하면 66나옴
	...
	//	double result = (double) x / (double)y; // 1.0 / 2.0 
	//	double result = x / (double)y; // 1.0 / 2.0 
		...
		double result2 = num1 + num2; // 큰 수따라가서 double 없어도 괜춘
