...
public class CharExample {
	...
	public static void main(String[] args) {
		...
		char c1 = 'A'; //실제로는 A가 아닌 유니코드 값인 65가 메모리에 저장됨
	...
	//	char cc = -65; //음수값 저장 안됨, 유니코드는 0부터 시작
		...
		/*
		 * 중요
		 * 1) 문자와 문자열은 다르다. -> 문자는 '' , 문자열은 ""
		 * 2)빈 문자 처리에 대해 
		 */
		
		//char c = ''; //컴파일 에러(빈 문자는 저장할 수 없다)
		char c = ' '; // 공백 문자(유니코드 32)는 저장 가능
		//System.out.println((int)' ');
		String str = ""; // 빈 문자열(empty string) 저장 가능 - String은 대문자 시작
